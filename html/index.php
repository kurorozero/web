...
<script src="../js/zero.js" type="text/javascript" language="javascript"></script>
<!--[if IE 6]>
...
window.onload=function(){
	alert(css(document.getElementById('test'),'background-color'))
}
</script>
<style>
...
<div class="wrap">
    ...
    <div class="top_box">
    	<div id="test" class="box rad shadow">
        	<ul>

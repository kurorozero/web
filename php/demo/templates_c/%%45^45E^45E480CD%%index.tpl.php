<?php /* Smarty version 2.6.26, created on 2012-04-12 18:01:05
         compiled from index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'config_load', 'index.tpl', 1, false),array('function', 'html_options', 'index.tpl', 14, false),array('function', 'html_select_date', 'index.tpl', 108, false),array('function', 'html_select_time', 'index.tpl', 114, false),array('modifier', 'capitalize', 'index.tpl', 10, false),array('modifier', 'truncate', 'index.tpl', 30, false),array('modifier', 'default', 'index.tpl', 33, false),array('modifier', 'escape', 'index.tpl', 36, false),array('modifier', 'replace', 'index.tpl', 39, false),array('modifier', 'regex_replace', 'index.tpl', 40, false),array('modifier', 'count_characters', 'index.tpl', 43, false),array('modifier', 'cat', 'index.tpl', 46, false),array('modifier', 'count_words', 'index.tpl', 49, false),array('modifier', 'date_format', 'index.tpl', 52, false),array('modifier', 'upper', 'index.tpl', 62, false),)), $this); ?>
<?php echo smarty_function_config_load(array('file' => "test.conf",'section' => 'setup'), $this);?>

<?php echo smarty_function_config_load(array('file' => "mytest.conf"), $this);?>
...
1 + 2 = ? (<?php echo ($this->_tpl_vars['num1']+$this->_tpl_vars['num2']); ?>
)

<?php echo 'index.tpl'; ?>


<?php echo $this->_config[0]['vars']['testsay']; ?>


<?php echo @PATH; ?>


<?php echo ((is_array($_tmp=$this->_tpl_vars['long_str'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 20, "...") : smarty_modifier_truncate($_tmp, 20, "...")); ?>


≤‚ ‘ƒ¨»œ÷µmyTitle <?php echo ((is_array($_tmp=@$this->_tpl_vars['myTitle'])) ? $this->_run_mod_handler('default', true, $_tmp, 'no value') : smarty_modifier_default($_tmp, 'no value')); ?>


<?php echo ((is_array($_tmp=@LINK)) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>


<?php echo ((is_array($_tmp=$this->_tpl_vars['matchStr'])) ? $this->_run_mod_handler('replace', true, $_tmp, 'my', 'your') : smarty_modifier_replace($_tmp, 'my', 'your')); ?>

<?php echo ((is_array($_tmp=$this->_tpl_vars['matchStr'])) ? $this->_run_mod_handler('regex_replace', true, $_tmp, "/[\r\t\n]/", ' ') : smarty_modifier_regex_replace($_tmp, "/[\r\t\n]/", ' ')); ?>


it's <?php echo ((is_array($_tmp=$this->_tpl_vars['long_str'])) ? $this->_run_mod_handler('count_characters', true, $_tmp) : smarty_modifier_count_characters($_tmp)); ?>
 chars by $long_str

it's cat long_str & long_str2: <?php echo ((is_array($_tmp=$this->_tpl_vars['long_str'])) ? $this->_run_mod_handler('cat', true, $_tmp, $this->_tpl_vars['long_str2']) : smarty_modifier_cat($_tmp, $this->_tpl_vars['long_str2'])); ?>


<?php echo ((is_array($_tmp=$this->_tpl_vars['long_str2'])) ? $this->_run_mod_handler('count_words', true, $_tmp) : smarty_modifier_count_words($_tmp)); ?>
...
<?php $_from = $this->_tpl_vars['index_arr']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['curval']):
?>
	<br /><?php echo $this->_tpl_vars['curval']; ?>
